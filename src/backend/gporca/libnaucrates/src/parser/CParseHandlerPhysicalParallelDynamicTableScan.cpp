...
//
//	@filename:
//		CParseHandlerPhysicalParallelDynamicTableScan.cpp
//
//	@doc:
//		Implementation of the SAX parse handler class for parsing parallel
//		dynamic table scan operators
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//	@function:
//		CParseHandlerPhysicalParallelDynamicTableScan::StartElement
//
//	@doc:
	...
	const Attributes &attrs)
{
	...
	// parse parallel workers attribute
...
//---------------------------------------------------------------------------
//	@function:
//		CParseHandlerPhysicalParallelDynamicTableScan::EndElement
//
//	@doc:
...
)
{
	...
	CDXLPhysicalParallelDynamicTableScan *dxl_op =
		GPOS_NEW(m_mp) CDXLPhysicalParallelDynamicTableScan(
