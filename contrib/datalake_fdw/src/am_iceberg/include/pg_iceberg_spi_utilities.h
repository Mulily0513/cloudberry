/*-------------------------------------------------------------------------
 *
 * pg_iceberg_spi_utilities.h
 *    Iceberg SPI helper macros and utilities
 *
 * This file provides a set of macros to simplify interaction with the
 * PostgreSQL Server Programming Interface (SPI). It handles datum
 * conversion, argument passing, and query execution with common
 * boilerplate like disabling query tracking.
 *
 * IDENTIFICATION
 *    contrib/datalake_fdw/src/am_iceberg/include/pg_iceberg_spi_utilities.h
 *
 *-------------------------------------------------------------------------
 */

#ifndef __PG_ICEBERG_SPI_UTILITIES_H__
#define __PG_ICEBERG_SPI_UTILITIES_H__
...
#endif /* __PG_ICEBERG_SPI_UTILITIES_H__ */
